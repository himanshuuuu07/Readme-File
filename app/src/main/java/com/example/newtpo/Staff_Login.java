            ...
            public void onClick(View v) {
                ...
                fAuth.signInWithEmailAndPassword(email,password).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                    ...
                    public void onSuccess(AuthResult authResult) {
                        ...
                        Toast.makeText(Staff_Login.this,"Loggedin Sucessfully",Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull @NotNull Exception e) {
                        Toast.makeText(Staff_Login.this,e.getMessage(),Toast.LENGTH_SHORT).show();
        ...
        df.get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                if(documentSnapshot.getString("isStaff")!=null){
                    startActivity(new Intent(getApplicationContext(),Staff_Home_Page.class));
                    finish();
                }
            }
        });
