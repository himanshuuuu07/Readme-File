...
public class edit_student_profile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter1=new ArrayAdapter<>(edit_student_profile.this, R.layout.branch_item, items1);
        stu_branch.setAdapter(adapter1);

        ArrayAdapter<String> adapter2=new ArrayAdapter<>(edit_student_profile.this, R.layout.branch_item, items2);
        stu_gender.setAdapter(adapter2);

        ArrayAdapter<String> adapter3=new ArrayAdapter<>(edit_student_profile.this, R.layout.branch_item, items3);
        stu_year_ofStudy.setAdapter(adapter3);

        ArrayAdapter<String> adapter4=new ArrayAdapter<>(edit_student_profile.this, R.layout.branch_item, items4);
    ...
    public void btn_update_student_profile(View view) {
       ...
       dRef.set(stu).addOnSuccessListener(new OnSuccessListener<Void>() {
           ...
           public void onFailure(@NonNull Exception e) {
             Toast.makeText(edit_student_profile.this,"Eroor"+e.getMessage(),Toast.LENGTH_SHORT).show();
           }
       });
...
//               }
//               else {
//                   Toast.makeText(edit_student_profile.this,"Error",Toast.LENGTH_SHORT).show();
//               }
//           }
//       });
